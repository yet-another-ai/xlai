//! C ABI entrypoint for embedding XLAI in native code. Wraps the `xlai-native` crate; not published to crates.io.
//!
//! For Rust applications, use `xlai-native` directly.
