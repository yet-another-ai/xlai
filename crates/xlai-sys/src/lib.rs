//! Low-level native dependencies for xlai: **llama.cpp** (chat) and/or standalone **ggml** (QTS).
//!
//! Enable `llama` and/or `qts-ggml`; other feature flags configure BLAS/GPU backends for the
